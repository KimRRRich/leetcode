...
public:
    ...
    bool validPath(int n, vector<vector<int>>& edges, int source, int destination) {
        ...
        //     if(isInVector(edges[i][0],nums)&&!isInVector(edges[i][1],nums)){
        //         if(edges[i][1]==destination) return true;
        //         else nums.push_back(edges[i][1]);
        //    }
        //    if(isInVector(edges[i][1],nums)&&!isInVector(edges[i][0],nums)){
        //     if(edges[i][0]==destination) return true;
        //     else nums.push_back(edges[i][0]);
        //    }
        // }
        // }
    ...
    // bool isInVector(int a,vector<int>& nums){
